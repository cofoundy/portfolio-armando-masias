export const siteConfig = {
  ...
  description:
    "Armando Masías — experienced yacht deckhand and tender driver based in Fort Lauderdale. Tender operations, exterior maintenance, and guest support across private and commercial vessels.",

  // 2-color system: deep navy + steel ocean blue (navy & white, minimalist)
  accentColor: "#0F2A4A",
  highlightColor: "#3B6E9C",

  // Hero stats (factual — no inflated tenure)
  stats: [
    { value: "8", label: "Vessels crewed" },
  ...
  social: {
    ...
    instagram: "https://instagram.com/armandoanthony33",
  },
  ...
  skills: [
    ...
    "Teak deck cleaning & restoration",
    "Mooring & unmooring",
    "Docking & undocking",
    "Helmsman / steering",
    "Line handling & fendering",
    "Anchoring operations",
    "Bridge watchkeeping & lookout",
    "ISM / ISPS compliance",
    "Safety equipment & PPE",
    "Guest services & hospitality",
  ],

  // "Projects" section repurposed → Certifications & Clearances
  projects: [
    {
      name: "STCW Safety & Security",
      description:
  ...
  experience: [
    ...
    {
      company: "M/Y Maje — Fort Lauderdale",
      title: "Mate / Deckhand",
    ...
    {
      company: "M/Y Epic & M/Y Intrepid — Fort Lauderdale",
      title: "Deckhand",
      dateRange: "Feb 2026",
      bullets: [
    ...
    {
      company: "LPG/C Atlantic Victory",
  ...
  education: [
    {
      school: "Caribbean Maritime University",
      degree: "Maritime Training — Jamaica",
      dateRange: "",
      achievements: [],
    },
    {
      school: "Merchant Marine School (ENAMM)",
      degree: "Merchant Marine Training — Peru",
      dateRange: "",
      achievements: [],
    },
    {
      school: "Continental Aquatic Training & Development Center",
      degree: "Aquatic & Diving Training",
      dateRange: "",
      achievements: [],
    },
  ],
...
// ──────────────────────────────────────────────────────────────────────────
// Bilingual content (EN default, ES secondary toggle)
// Only translatable copy lives here. Proper nouns (vessel names M/Y Koju,
// M/T Alejandro…, school names, cert codes STCW/IMO/ISM/ISPS/ENG1/PADI/B1/B2)
// are NOT translated. The EN strings mirror siteConfig above (server-rendered
// first paint); ES is applied client-side via localStorage.
// ──────────────────────────────────────────────────────────────────────────
export const langConfig = {
  en: {
    ...
    // Stat labels (values stay the same)
    stats: ["Vessels crewed", "Certifications", "Languages"],

    // Skills (order matches siteConfig.skills)
    skills: [
      "Tender operations & guest transfer",
      "Exterior maintenance & detailing",
      "Teak deck cleaning & restoration",
    ...
    // Certifications (order matches siteConfig.projects)
    projects: [
      {
        name: "STCW Safety & Security",
        description:
    ...
    // Experience titles + bullets (order matches siteConfig.experience; companies/dates unchanged)
    experience: [
      {
        title: "Deckhand / Exterior Maintenance",
        bullets: [
    ...
    // Education degrees (order matches siteConfig.education; schools unchanged)
    education: [
      "Maritime Training — Jamaica",
      "Merchant Marine Training — Peru",
      "Aquatic & Diving Training",
    ],
  },
  ...
  es: {
    ...
    // Stat labels
    stats: ["Embarcaciones tripuladas", "Certificaciones", "Idiomas"],

    // Skills
    skills: [
      "Operación de tenders y traslado de pasajeros",
      "Mantenimiento exterior y detallado",
      "Limpieza y restauración de cubierta de teca",
      "Amarre y desamarre",
      "Atraque y desatraque",
      "Timonel / gobierno de la embarcación",
      "Manejo de cabos y defensas",
      "Operaciones de fondeo",
      "Guardia de puente y vigía",
      "Cumplimiento ISM / ISPS",
      "Equipo de seguridad y EPP",
      "Atención a pasajeros y hotelería",
    ],

    // Certifications
    projects: [
      {
        name: "Seguridad y Protección STCW",
        description:
          "Certificado de Competencia II/5 · Formación Básica en Seguridad IMO 1.13 / 1.19 / 1.20 / 1.21 · Concienciación Ambiental Marina IMO 1.38 · Formación en Protección para Gente de Mar con Funciones de Protección Designadas IMO 3.26 · Concienciación en Protección IMO 3.27",
      },
      {
        name: "Códigos y Cumplimiento",
        description:
          "Certificado del Código ISM · Certificado del Código ISPS · Inducción en Primeros Auxilios Básicos · Manipulación, Almacenamiento y Preparación de Alimentos a Bordo (Convenio OIT 1946)",
      },
      {
        name: "Documentos y Habilitaciones",
        description:
          "Visa estadounidense B1/B2 (vigente hasta feb. 2034) · Certificado médico ENG1 (vigente hasta ene. 2028) · PADI Open Water Diver · Licencia de conducir vigente",
      },
    ],
    ...
    // Education degrees
    education: [
      "Formación Marítima — Jamaica",
      "Formación de Marina Mercante — Perú",
      "Formación Acuática y de Buceo",
    ],
  },
} as const;
